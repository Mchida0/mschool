    ...
    <div class="container">
        <div class="row">
            <div class="col-md-15">
                ...
                Puji syukur kepada Allah SWT, Tuhan Yang Maha Esa yang telah memberikan rahmat dan anugerahnya sehingga website SEKOLAH SD Negeri Layansari 03 ini dapat muncul di dunia pendidikan. Melalui layanan internet dan online selama 24 jam, Salah satu tujuan dari website ini adalah untuk menjawab akan setiap kebutuhan informasi dengan memanfaatkan sarana teknologi informasi yang ada.
                Semoga dengan adanya website ini dapat membantu dan bermanfaat, terutama informasi yang berhubungan dengan pendidikan, ilmu pengetahuan dan informasi seputar sekolah.
                Akhirnya kami mengharapkan masukan dari berbagai pihak untuk website ini agar kami terus belajar dan meng-update diri, sehingga tampilan, isi dan mutu website akan terus berkembang dan lebih baik nantinya. Terima kasih atas kerjasamanya, maju terus untuk mencapai cita-cita yang lebih baik lagi.
                </h4>
                <br/>
                <h4>Wassalamu'alaikum wr.wb.</h4>
                </div>
            </div>
        </div>
    </section>
