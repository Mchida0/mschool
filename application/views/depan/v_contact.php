                        ...
                        <div class="col-xs-12 col-sm-12 col-md-6 contact-option">
                            <div class="contact-option_rsp">
                                ...
                                <form action="<?php echo site_url('contact/kirim_pesan');?>" method="post">
                                    ...
                                    <!-- // end .form-group -->
                                    <div class="form-group">
                                        <input type="text" class="form-control" placeholder="No Telp" name="xphone" required>
                                    </div>
                                    <!-- // end .form-group -->
                                    <div class="form-group">
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-6">
                            <div class="contact-address">
                                ...
                                <div class="contact-details">
                                    ...
                                    <h6>Alamat</h6>
                                    <p>jln.A. Yani Wungureja, 
                                        <br> Gandrungmangu Cilacap
                                        <br> INA. 53254</p>
                                    </div>
                                    <br>
                                    <div class="contact-details">
            ...
            <div class="col-md-3">
                ...
                <div class="col-md-3">
                    <div class="address">
                        ...
                        <p>Email : sdndukuhturi03@gmail.com</p>
