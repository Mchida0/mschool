                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-7">
                                            <input type="text" name="xbidang" class="form-control" id="inputUserName" placeholder="Contoh: Kepala Sekolah, Wali Kelas 1" required>
                                        </div>
                                    </div>
                    ...
                    <div class="modal-body">
                                ...
                                <input type="hidden" value="<?php echo $photo;?>" name="gambar">
                                    ...
                                    <div class="form-group">
                                        <label for="inputUserName" class="col-sm-4 control-label">-</label>
                                        <div class="col-sm-7">
                                            <input type="text" name="xbidang" value="<?php echo $bidang;?>" class="form-control" id="inputUserName" placeholder="Contoh: Kepala Sekolah, Wali Kelas 1" required>
                                        </div>
                                    </div>
